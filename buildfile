...
ENV['JAVA_HOME'] ||= '/usr/lib/jvm/java-5-sun'
...
SIGNPOST = ['oauth.signpost:signpost-core:jar:1.2.1.1', 'oauth.signpost:signpost-commonshttp4:jar:1.2.1.1']
...
define "RESTProviderAll", :layout => android_layout do
  ...
  define "RESTProvider" do
    project.compile.sources << _('gen')
  	...
  	compile.with COMMONS_CODEC, SIGNPOST, JACKSON, DOM4J, DROIDFU, File.expand_path('android.jar', ENV['ANDROID_HOME'] + "/platforms/android-2.0")
