...
public class JsonCursorTest {
    ...
    //    
    // @Test
    // public void testEmptyJsonShouldReturnCursorWithCountZero() throws
    // Exception {
    // String json = "{}";
    // jsonCursor = new JsonCursor((String)"root").handleResponse(json);
    // assertEquals(0, jsonCursor.getCount());
    // }
    //
    // @Test
    // public void testOneDepthJSON() throws Exception {
    // String json = "{\"test\":\"value\"}";
    // JsonCursor cursor = new JsonCursor().handleResponse(json);
    ...
    // String json =
    // "{\"root\": [{\"test\": \"value\"},{\"test\": \"value2\"}]}";
    // JsonCursor cursor = new JsonCursor("root").handleResponse(json);
    ...
    // String json = "[{\"test\": \"value\"},{\"test\": \"value2\"}]";
    // JsonCursor cursor = new JsonCursor(null).handleResponse(json);
    // assertEquals(2, cursor.getCount());
    // assertTrue(cursor.moveToFirst());
    // assertEquals("value", cursor.getString(0));
    // assertTrue(cursor.moveToNext());
    ...
    // String json =
    // "{\"root\": [{\"test\": \"value\"},{\"test\": \"value2\"}]}";
    // JsonCursor cursor = new JsonCursor("root", true,
    // "test").handleResponse(json);
    // assertEquals(2, cursor.getCount());
    // assertTrue(cursor.moveToFirst());
    // assertEquals("value",
    ...
    // JsonCursor cursor = new
    // JsonCursor("root").withForeignKey("test").handleResponse(json);
    // assertTrue(cursor.moveToFirst());
    ...
    // assertEquals("A State of Trance",
    // tree.getString(tree.getColumnIndexOrThrow("artist")));
    // assertTrue(tree.moveToNext());
    // assertEquals("Simon Patterson",
    // tree.getString(tree.getColumnIndexOrThrow("artist")));
    // }
    //    
    // @Test
    ...
    // String json = "{\"test\":[]}";
    // JsonCursor cursor = new JsonCursor("test", true,
    // "id").handleResponse(json);
