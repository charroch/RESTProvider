...
public class JsonCursorTest {
    ...
    public void testsimpleJSONwithRootNamedNode() throws Exception {
        String json = "{\"root\": [{\"test\": \"value\"},{\"test\": \"value2\"}]}";
        JsonCursor cursor = new JsonCursor("root", true, "test").handleResponse(json);
        assertEquals(2, cursor.getCount());
        assertTrue(cursor.moveToFirst());
        assertEquals("value", cursor.getString(cursor.getColumnIndexOrThrow("_id")));
        assertTrue(cursor.moveToNext());
        assertEquals("value2", cursor.getString(cursor.getColumnIndexOrThrow("_id")));
    }
    ...
    public void testJSONWithForeignKeys() throws Exception {
        ...
        JsonCursor cursor = new JsonCursor("root").withForeignKey("test").handleResponse(json);
        assertTrue(cursor.moveToFirst());
    ...
    public void testComplexJsonWithForeignKeys() throws Exception {
        ...
        JsonCursor cursor = new JsonCursor("sets", true, "id").withForeignKey("tracks")
                .handleResponse(json);
        assertTrue(cursor.moveToFirst());
    ...
    public void testEmptyArray() throws Exception {
        String json = "{\"test\":[]}";
        JsonCursor cursor = new JsonCursor("test", true, "id").handleResponse(json);
